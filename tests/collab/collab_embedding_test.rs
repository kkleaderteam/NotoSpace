...
async fn query_collab_embedding_after_create_test() {
  ...
  let contents = vec![
    "Noto is an open-source project.",
    "It is an alternative to tools like Notion.",
    "Noto provides full control of your data.",
    "The project is built using Flutter for the frontend.",
    "Rust powers Noto's backend for safety and performance.",
    "Noto supports both personal and collaborative workflows.",
    "It is customizable and self-hostable.",
    "Users can create documents, databases, and workflows with Noto.",
    "The community contributes actively to Noto's development.",
    "Noto aims to be fast, reliable, and feature-rich.",
  ];
...
async fn document_full_sync_then_search_test() {
  ...
  assert_eq!(items[0].preview, Some("Noto is an open-source project.It is an alternative to tools like Notion.Noto provides full control of your data.The project is built using Flutter for the frontend.Rust powers Noto's back".to_string()));
}
