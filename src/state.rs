...
use NOTO_collaborate::metrics::CollabMetrics;
use NOTO_collaborate::ws2::WsServer;
use NOTO_collaborate::CollabRealtimeMetrics;
...
use crate::api::metrics::{NotoWebMetrics, PublishedCollabMetrics, RequestMetrics};
...
pub struct AppMetrics {
  ...
  pub NOTO_web_metrics: Arc<NotoWebMetrics>,
...
impl AppMetrics {
  pub fn new() -> Self {
    ...
    let NOTO_web_metrics = Arc::new(NotoWebMetrics::register(&mut registry));
