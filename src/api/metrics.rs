...
impl RequestMetrics {
  ...
  pub fn register(registry: &mut Registry) -> Self {
    ...
    let af_registry = registry.sub_registry_with_prefix("notospace_cloud");
...
impl NotoWebMetrics {
  ...
  pub fn register(registry: &mut Registry) -> Self {
    let metrics = Self::init();
    let web_update_registry = registry.sub_registry_with_prefix("NOTO_web");
