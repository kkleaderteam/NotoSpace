...
fn document_plain_text() {
  ...
  let expected = "Welcome to Noto$Download for macOS, Windows, and Linux link$$$quick start Ask AI powered by advanced AI models: chat, search, write, and much more ✨---❤\u{fe0f}Love Noto and open source? Follow our latest product updates:Twitter: @NotoReddit: r/NotoGithub";
