...
- `Noto_INDEXER_ENABLED`: Enable/disable the indexing system (default: `true`)
- `Noto_INDEXER_SCHEDULER_NUM_THREAD`: Number of threads for processing (default: `50`)
