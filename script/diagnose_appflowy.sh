...
# =============================================================================
# Noto Cloud - Diagnostic Tool
# =============================================================================
# This script diagnoses common issues with Noto Cloud docker-compose
# deployments, particularly login and authentication problems.
#
# Usage: ./script/diagnose_Noto.sh [OPTIONS]
#
# Options:
...
REPORT_FILE="$PROJECT_ROOT/NOTO_diagnostic_$TIMESTAMP.log"
...
main() {
    ...
    if [[ "$JSON_OUTPUT" != "true" ]]; then
        print_header "Noto Cloud Diagnostic Tool v${SCRIPT_VERSION}"
        echo ""
    fi
