...
# =============================================================================
# Noto Cloud - Environment File Generator
# =============================================================================
...
show_help() {
    echo "Noto Cloud Environment File Generator"
    echo
...
main() {
    ...
    print_header "Noto Cloud Environment Generator"
    ...
    echo
    print_info "You can now use the generated .env file with your Noto Cloud deployment."
