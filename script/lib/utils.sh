...
# =============================================================================
# Noto Cloud - Diagnostic Tool - Utility Functions
# =============================================================================
...
show_help() {
    cat << EOF
Noto Cloud Diagnostic Tool v${SCRIPT_VERSION}

Usage: $0 [OPTIONS]

This tool diagnoses common issues with Noto Cloud docker-compose
