Noto PTE. LTD. SOFTWARE LICENSE AGREEMENT

IMPORTANT: PLEASE READ THIS SOFTWARE LICENSE AGREEMENT ("LICENSE
AGREEMENT") CAREFULLY BEFORE USING THE Noto SELF-HOSTED COMMERCIAL
...
1. License Grant: Subject to the terms and conditions of this License
   Agreement, Noto PTE. LTD. ("Licensor") grants you a
...
3. License Key:
   ...
   a)  Noto PTE. LTD. will provide you with a unique license key
   ("License Key") to activate the Software on a specific server
   (machine).
   b)  You agree that the License Key provided to you by Noto PTE.
   ...
   (machine) without explicit written permission from Noto PTE.
   LTD.
